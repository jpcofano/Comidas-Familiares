      ...
      <div style={{ marginBottom: "var(--space-4)" }}>
        ...
        {lista && itemsVisibles.length > 0 && (
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
            ...
            <button
              onClick={() => {
                const mapped = itemsVisibles.map((it) => ({
                  nombre:   it.nombrePreferido,
                  cantidad: it.cantidadLabel,
                  seccion:  it.seccionGondola,
                  comprado: it.yaTengo,
                }));
                void compartirLista(construirTextoLista("Lista de compras", null, mapped));
              }}
              style={{
